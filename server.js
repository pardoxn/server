...
app.post('/api/auth/login', (req,res)=>{
  ...
  res.setHeader('Set-Cookie', `auth_token=${encodeURIComponent(token)}; Path=/; SameSite=None; Secure; HttpOnly`);
...
app.post('/api/auth/logout', (req,res)=>{
  ...
  res.setHeader('Set-Cookie', 'auth_token=; Path=/; Max-Age=0; SameSite=None; Secure; HttpOnly');
  res.json({ ok:true });
});
